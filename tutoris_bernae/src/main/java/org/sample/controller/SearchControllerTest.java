...
//        when(searchService.saveFrom(any(RegisterForm.class))).thenReturn(null);
...
//        when(searchService.saveFrom(any(RegisterForm.class))).thenThrow(new InvalidUserException("invalidUserTest"));
//        mockMvc = MockMvcBuilders.standaloneSetup(searchController).build();
//        mockMvc.perform(post("/submit").param("email", "mail@mail.de")
//                .param("firstName", "first")
//                .param("lastName", "last")
