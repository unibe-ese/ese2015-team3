    ...
    <fieldset>
        ...
        <div class="control-group<c:if test="${not empty emailErrors}"> error</c:if>">
            ...
            <div class="controls" style="width:30%;min-width:150px;max-width:450px">
                <form:input path="email" id="field-email" tabindex="1" maxlength="45" value="${user.email}" style="color:black"/>
        ...
        <div class="control-group<c:if test="${not empty firstNameErrors}"> error</c:if>">
            ...
            <div class="controls" style="width:30%;min-width:150px;max-width:450px">
                <form:input path="firstName" id="field-firstName" tabindex="2" maxlength="35" value="${user.firstName}" style="color:black"/>
        ...
        <div class="control-group<c:if test="${not empty lastNameErrors}"> error</c:if>">
            ...
            <div class="controls" style="width:30%;min-width:150px;max-width:450px">
                <form:input path="lastName" id="field-lastName" tabindex="3" maxlength="35" value="${user.lastName}" style="color:black"/>
        ...
        <div class="control-group<c:if test="${not empty usernameErrors}"> error</c:if>">
            ...
            <div class="controls" style="width:30%;min-width:150px;max-width:450px">
                <form:input path="username" id="field-username" tabindex="3" maxlength="35" value="${user.username}" style="color:black"/>
